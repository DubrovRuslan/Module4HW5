    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "boss@tesla.com", "Elon", "Musk" },
                    { 2, "boss@facebook.com", "Mark", "Zuckerberg" },
                    { 3, "boss@linux.com", "Linus", "Torvalds" },
                    { 4, "boss@microsoft.com", "Bill", "Gates" },
                    { 5, "boss@amazon.com", "Jeffrey", "Bezos" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1000m, 0, "Tesla", new DateTime(2023, 8, 8, 13, 16, 47, 738, DateTimeKind.Utc).AddTicks(6450) },
                    { 2, 2000m, 0, "Facebook", new DateTime(2023, 8, 8, 13, 16, 47, 738, DateTimeKind.Utc).AddTicks(6457) },
                    { 3, 3000m, 0, "Linux", new DateTime(2023, 8, 8, 13, 16, 47, 738, DateTimeKind.Utc).AddTicks(6459) },
                    { 4, 4000m, 0, "Windows XP", new DateTime(2023, 8, 8, 13, 16, 47, 738, DateTimeKind.Utc).AddTicks(6461) },
                    { 5, 5000m, 0, "Blue Origin", new DateTime(2023, 8, 8, 13, 16, 47, 738, DateTimeKind.Utc).AddTicks(6463) }
                });
